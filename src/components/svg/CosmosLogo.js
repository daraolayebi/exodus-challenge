...
const CosmosLogo = () => {
    return (
        <svg width="80" height="80" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs><linearGradient x1="22.351%" y1="-12.223%" x2="98.837%" y2="152.777%" id="a"><stop stopColor="#383C58" offset="0%"/><stop stopColor="#1B1E36" offset="100%"/></linearGradient></defs>
            <g transform="scale(2, 2)" fill="none" fillRule="evenodd">
                ...
                <g transform="translate(8 6)" fillRule="nonzero">
                    ...
                    <ellipse fill="#B7B9C8" cx="18.994" cy="7.654" rx="1" ry="1"/>
                    <ellipse fill="#B7B9C8" cx="3.289" cy="11.02" rx="1" ry="1"/>
                    <ellipse fill="#B7B9C8" cx="10.284" cy="23.161" rx="1" ry="1"/>
                </g>
            </g>
        </svg>
    );
